...
Google's Gemini Deep Research represents a new class of AI: agents that don't just answer questions, but *investigate*. Given a research objective, these agents:
- Autonomously plan multi-step research strategies
- Execute 80-160 web searches per investigation
- Synthesize dozens of sources into coherent reports
- Track citations automatically throughout
- Run for up to 60 minutes per task, unsupervised
...
#### Research Agents (Gemini Deep Research)
...
- **Run unsupervised**: 15-60 minutes per task, no human intervention

**Key capability**: Research agents run in parallel. While investigating problems for Opportunity A, the machine simultaneously researches markets for B, competitors for C, and solutions for D.
...
| **Research** | Gemini Deep Research | Autonomous multi-step investigation |
